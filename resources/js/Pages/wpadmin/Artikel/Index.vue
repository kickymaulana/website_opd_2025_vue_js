...
watch(cari, (nilaibaru, nilaiawal) => {
    router.get('/wp-admin/artikel/index', { cari: nilaibaru }, { preserveState: true, replace: true });
});
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex">
                                    <Link href="/wp-admin/artikel/create" class="btn btn-primary btn-sm">Tambah</Link>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in list_artikel.data" :key="index">
                                        <td>{{ item.judul }}</td>
                                        <td class="text-end">
                                            <Link :href="`/wp-admin/artikel/${ item.id }/show`" class="btn btn-primary"><i class="bi bi-info-square"></i></Link>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <nav aria-label="...">
                                <ul class="pagination">
                                    <li class="page-item" :class="{
                                        'active' : link.active,
                                        'disabled' : !link.url
                                    }" aria-current="page" v-for="link in list_artikel.meta.links" :key="link.label">
