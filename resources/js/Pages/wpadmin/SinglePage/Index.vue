...
watch(cari, (nilaibaru, nilaiawal) => {
    router.get('/wp-admin/single-page/index', { cari: nilaibaru }, { preserveState: true, replace: true });
});
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Single Page</h5>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex">
                                    <Link href="/wp-admin/single-page/create" class="btn btn-primary btn-sm">Tambah</Link>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in list_single_page.data" :key="index">
                                        <td>{{ item.nama }}</td>
                                        <td class="text-end">
                                            <Link :href="`/wp-admin/single-page/${ item.id }/show`" class="btn btn-primary"><i class="bi bi-info-square"></i></Link>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <nav aria-label="...">
                                <ul class="pagination">
                                    <li class="page-item" :class="{
                                        'active' : link.active,
                                        'disabled' : !link.url
                                    }" aria-current="page" v-for="link in list_single_page.meta.links" :key="link.label">
